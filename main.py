...
class WebScraper:
    ...
    def scrape_website(self, url):
        ...
        try:
            ...
            data = {
                ...
                'technical': self._extract_technical_data(page, soup),
    ...
    def _extract_content(self, soup):
        ...
        for i in range(1, 7):
            ...
            content['headings'][f'h{i}'] = [h.text.strip() for h in headings]
    ...
    def _extract_technical_data(self, page, soup):
        ...
        return {
            ...
            'response_headers': dict(page.request.headers) if hasattr(page, 'request') else {},
            'security': {
    ...
    def _extract_seo_data(self, soup):
        ...
        return {
            ...
            'meta_description_length': len(soup.find('meta', attrs={'name': 'description'}).get('content', '')) if soup.find('meta', attrs={'name': 'description'}) else 0,
            'h1_count': len(soup.find_all('h1')),
            'images_without_alt': len(soup.find_all('img', alt=False)),
            'internal_links': 0,  # Will be calculated in _extract_links
            'external_links': 0   # Will be calculated in _extract_links
        }
...
def home():
    ...
    return jsonify({
        ...
        'usage': 'POST to /scrape with {"url": "https://example.com"}',
        'endpoints': {
